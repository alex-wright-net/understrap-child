...
/* OVERRIDE understrap_scripts WITH CUSTOM SCRIPTS + STYLES
current as of understrap_child version: 0.3.9
================================================== */
...
function theme_enqueue_styles() {
    ...
    wp_enqueue_script( 'custom-scripts', get_stylesheet_directory_uri() . '/js/style.min.js', array(), $the_theme->get( 'Version' ), true );
